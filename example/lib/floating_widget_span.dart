...
@immutable
class FloatingWidgetSpan extends WidgetSpan {
  ...
  RenderComparison compareTo(InlineSpan other) {
    ...
    final FloatingWidgetSpan typedOther = other as FloatingWidgetSpan;
  ...
  bool operator ==(Object other) {
    ...
    return other is FloatingWidgetSpan &&
        other.child == child &&
